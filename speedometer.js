...
function drawSpeedometerColourArc(options) {
    ...
    drawSpeedometerPart(options, 1.0, "rgb(24, 201, 36)", green);
    drawSpeedometerPart(options, 0.9, "rgb(255,255,204)", yellow);
    drawSpeedometerPart(options, 0.9, "rgb(255,0,0) ", red);
...
function drawNeedle(options) {
    ...
    */
    ...
    drawNeedleDial(options, 0.6, "rgb(255, 60, 0)", "rgb(255,255,255)");
...
function drawWithInputSpeed() {

    var txtSpeed = document.getElementById('Speed');
